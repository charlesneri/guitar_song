...
const artists = [
  ...
  { name: 'Taylor Swift', image: '/image/taylor.jpg', route: '/swiftview' },
  { name: 'Ed Sheeran', image: '/image/ed.jpg', route: '/sheeranview' },
  { name: 'Selena Gomez', image: '/image/gomez.jpg', route: '/gomezview' },
